...
class Quiz_guess_word_english {
    arrays = {
        ...
        simple_conversations: [
            ...
            {p: "Nie rozumiem", e: "I dont understand"},
    ...
    setWordsList(data_lists){
        ...
        this.actualizeData(this.main_display_word_to_guess, this.random_words[this.question_index_value].p);
        ...
        this.number_of_words_to_guess = 10;
    }
    last_call = true;
    checkAnswer(input){
        
        const guessed_word = input.value.trim();
        if(guessed_word.toLowerCase() == this.random_words[this.question_index_value].e.toLowerCase()){
